...
async def get_search_results(query: str, retriever: Any, query_domains: List[str] = None, researcher=None) -> List[Dict[str, Any]]:
    ...
    headers = researcher.headers if researcher and hasattr(researcher, "headers") else None
    ...
    if researcher is not None and hasattr(search_retriever, "last_debug"):
        researcher.last_search_debug = search_retriever.last_debug
    return results
