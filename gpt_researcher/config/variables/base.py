...
class BaseConfig(TypedDict):
    ...
    DISCORD_BOT_TOKEN: Union[str, None]
    DISCORD_GUILD_IDS: List[str]
    DISCORD_CHANNEL_IDS: List[str]
    DISCORD_LOOKBACK_HOURS: int
    DISCORD_MESSAGE_LIMIT: int
    DISCORD_TRANSCRIPT_DIR: str
    DISCORD_PREFILTER_ENABLED: bool
    DISCORD_PREFILTER_KEYWORDS: List[str]
    DISCORD_CONTEXT_WINDOW_MINUTES: int
    DISCORD_CONTEXT_MAX_MESSAGES: int
    DISCORD_DEDUPE_STORE_PATH: str
