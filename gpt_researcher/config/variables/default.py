...
DEFAULT_CONFIG: BaseConfig = {
    ...
    "DISCORD_TRANSCRIPT_DIR": "outputs/discord_transcripts",
    "DISCORD_PREFILTER_ENABLED": True,
    "DISCORD_PREFILTER_KEYWORDS": [
        "hiring",
        "looking for",
        "recruiter",
        "role",
    ...
    "DISCORD_CONTEXT_WINDOW_MINUTES": 45,
    "DISCORD_CONTEXT_MAX_MESSAGES": 12,
    "DISCORD_DEDUPE_STORE_PATH": "data/discord_scan_state.json",
}
