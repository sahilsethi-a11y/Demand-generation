...
Information: "{context}"
---
Based on the above information, answer the following query or task: "{question}".
Return ONLY a JSON object with the following fields:
- Name
- Website URL
- LinkedIn URL
- Portfolio Companies (array of strings)
- HQ

Do NOT include introductions, conclusions, headers, markdown, citations, or narrative text.
If a field is unknown, use null or an empty list for Portfolio Companies.
"""
...
"""
    ...
    @staticmethod
    def generate_hiring_signal_prompt(context: str, context_hint: str | None = None) -> str:
        hint = f"\nFILTER CONTEXT: {context_hint}\n" if context_hint else ""
        return f"""
You are an analyst extracting hiring intent from Discord community messages. Use ONLY the provided messages. If evidence is weak or missing, set has_hiring_intent to false and keep unknown fields as null. Return strict JSON only.
...
{{
  ...
  "intent_type": "direct_hiring | recruiter_post | vendor_search | talent_pipeline | unclear",
  "company_name": null,
