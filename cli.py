...
async def main(args):
    ...
    if args.report_type == 'detailed_report':
        ...
        custom_prompt = (
            "Based on the context, extract ONLY the following information for the company. "
            "Format the output strictly as a JSON object. Do NOT include an introduction, "
            "conclusion, headers, or any narrative text. Required fields: 1. Name, 2. "
            "Website URL, 3. LinkedIn URL, 4. Portfolio Companies (as a list), 5. HQ."
        )
