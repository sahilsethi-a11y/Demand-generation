...
export default function MobileHomeScreen({
  ...
  const canSubmit = Boolean(promptValue.trim() || (investorType && hqCountry));
  ...
  const handleSubmit = useCallback(async () => {
    if (!canSubmit || isLoading || isSubmitting) {
      return;
    }
  ...
  }, [promptValue, isLoading, isSubmitting, investorType, hqCountry, handleDisplayResult]);
  ...
  return (
    <div className="flex flex-col h-full w-full bg-gradient-to-b from-gray-900 to-gray-950 pb-16">
      ...
      <div className="px-4 md:px-8 w-full max-w-lg mx-auto">
        <div className="mb-4 rounded-xl border border-gray-700/60 bg-gray-900/70 p-4">
          <InvestorFilters
          ...
          <div className="absolute bottom-3 right-3">
            <button
              ...
              className={`rounded-full p-2 ${
                isLoading || isSubmitting || !canSubmit 
