...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // EMB TalentOS brand palette
        brand: {
          primary: '#1E40AF',    // deep blue — CTAs, active states
          secondary: '#0F172A',  // near black — headings, primary text
          surface: '#F8FAFC',    // off-white — page background
          card: '#FFFFFF',       // card backgrounds
          border: '#E2E8F0',     // dividers, card borders
          accent: '#6366F1',     // indigo — ICP score badges
        },
        status: {
        ...
        // Keep primary teal for backwards-compat
        'primary': {
          '50': '#f0fdfa',
          '100': '#ccfbf1',
          '200': '#99f6e4',
